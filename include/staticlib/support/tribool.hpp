...
#ifndef STATICLIB_SUPPORT_TRIBOOL_HPP
#define STATICLIB_SUPPORT_TRIBOOL_HPP

namespace staticlib { namespace support { namespace logic {
...
} } } // end namespace staticlib::support::logic

// Pull tribool and indeterminate into namespace "sl::support"
 ...
 *   }
 */
#define STATICLIB_HTTPSERVER_TRIBOOL_THIRD_STATE(Name)                                 \
inline bool                                                             \
Name(staticlib::support::logic::tribool x,                                           \
     staticlib::support::logic::detail::indeterminate_t =                            \
       staticlib::support::logic::detail::indeterminate_t())                         \
{ return x.value == staticlib::support::logic::tribool::indeterminate_value; }

#endif // STATICLIB_SUPPORT_TRIBOOL_HPP
